...
class Municipality extends BaseRecord
{
     ...
     * @var string
     */
    public $higher_regional_court_district;
     ...
     * @var string
     */
    public $regional_court_district;
     ...
     * @var string
     */
    public $employment_agency_district;
